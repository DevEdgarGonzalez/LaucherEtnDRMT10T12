...
public class WebViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        wvContainerWeb_fwv = (WebView) view.findViewById(R.id.wvContainerWeb_fwv);
        pb_fwv = (ProgressBar) view.findViewById(R.id.pb_fwv);
        tvUrl_fwv = (TextView) view.findViewById(R.id.tvUrl_fwv);
        imgvBack_fwv = (ImageView) view.findViewById(R.id.imgvBack_fwv);
        imgvRefresh_fwv = (ImageView) view.findViewById(R.id.imgvRefresh_fwv);
