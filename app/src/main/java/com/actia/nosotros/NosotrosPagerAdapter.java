...
public class NosotrosPagerAdapter extends PagerAdapter {

    private final Context context;
    private final LayoutInflater layoutInflater;
    private final ArrayList<File> alistFileImgNosotros;

    public NosotrosPagerAdapter(Context context, ArrayList<File> alistFileImgNosotros) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View itemView = layoutInflater.inflate(R.layout.item_pager_nosotros, container, false);

        ImageView imgvCoverItemPagerNosotros = itemView.findViewById(R.id.imgvCoverItemPagerNosotros);
