...
//  public void pause() {
//
//      if (player.isPlayWhenReadyCommitted()) {
...
//  private String[][] trackNames;
  private final int[] selectedTracks;
...
//  }
  ...
  private int getSelectedTrackIndex(int type) {
    return selectedTracks[type];
  }

  private void selectTrack(int type, int index) {
